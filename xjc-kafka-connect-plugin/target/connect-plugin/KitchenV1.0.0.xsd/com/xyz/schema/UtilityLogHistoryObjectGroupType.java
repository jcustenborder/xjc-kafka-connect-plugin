...
/**
 * An entry in the table of history properties for each utility type
 *                 logged.
 * 
 * <p>Java class for UtilityLogHistoryObjectGroupType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UtilityLogHistoryObjectGroupType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UtilityLogHistoryObjectGroupType", propOrder = {
    "index",
    "entryIndex",
    "value",
    "timestamp"
})
public class UtilityLogHistoryObjectGroupType
    implements Connectable
{
    ...
    static UtilityLogHistoryObjectGroupType() {
        SchemaBuilder builder = SchemaBuilder.struct();
        builder.name("com.xyz.schema.UtilityLogHistoryObjectGroupType");
        builder.optional();
