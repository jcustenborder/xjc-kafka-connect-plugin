    ...
    implements Connectable
{
    ...
    public Struct toStruct() {
        ...
        struct.put("responseTimestamp", this.responseTimestamp);
        struct.put("responseDescription", this.responseDescription);
        struct.put("businessError", this.businessError);
        struct.put("responseCode", this.responseCode);
        return struct;
    }
