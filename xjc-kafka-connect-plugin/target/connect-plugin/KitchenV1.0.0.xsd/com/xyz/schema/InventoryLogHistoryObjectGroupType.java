...
/**
 * Entry into logged values table.
 * 
 * <p>Java class for InventoryLogHistoryObjectGroupType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InventoryLogHistoryObjectGroupType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "InventoryLogHistoryObjectGroupType", propOrder = {
    "index",
    "entryIndex",
    "value",
    "timestamp"
})
public class InventoryLogHistoryObjectGroupType
    implements Connectable
{
    ...
    static InventoryLogHistoryObjectGroupType() {
        SchemaBuilder builder = SchemaBuilder.struct();
        builder.name("com.xyz.schema.InventoryLogHistoryObjectGroupType");
        builder.optional();
